...
import "@openzeppelin/contracts/utils/ReentrancyGuard";
import "@openzeppelin/contracts/utils/Counters.sol";
import "./ERC721PresetMinterPauserAutoId.sol";
import "./PoppyPenguinGeneGenerator";
import "./IPoppyPenguin";
...
contract PoppyPenguin is IPoppyPenguin, ERC721PresetMinterPauserAutoId, ReentrancyGuard {
    ...
    function _beforeTokenTransfer(address from, address tp, uint256 tokenId) internal virtual override (ERC721PresetMinterPauserAutoId) {
    ...
    function bulkBuy(uint256 amount) public override payable nonReentrant {
        ...
        for (uint256 i = 0; i < amount; i++) {
            ...
            emit TokenMinted(tokenId, _genes[tokenId]);
            emit TokenMorphed(tokenId, 0, -genes[tokenId], poppyPenguinPrice, PoppyPenguinEventType.MINT);
        }
